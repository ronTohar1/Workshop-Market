import { Box, Button, Card, CardContent, CardHeader, Dialog, DialogActions, DialogContent, DialogContentText, DialogTitle, Icon, Typography } from '@mui/material'
          ...
          >
            <DialogTitle id="alert-dialog-title">
              ...
              <Box sx={{display:'flex',justifyContent:'center'}}>
                <AssignmentIndIcon sx={{fontSize:100, }}/>
                </Box>
            </DialogTitle>
            <DialogContent>
