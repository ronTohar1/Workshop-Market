...
namespace TestMarketBackend.Acceptance
{
    internal class Guest_MemberReqsTests : AcceptanceTests
    {
        ...
        public void SuccessfulPurchase()
        {
            ...
            Response<ServicePurchase> response = buyerFacade.PurchaseCartContent(member3Id, paymentDetails);
        ...
        public void FailedPurchaseProductsOutOfStock()
        {
            ...
            Response<ServicePurchase> firstUserResponse = buyerFacade.PurchaseCartContent(member2Id, paymentDetails);
            Assert.True(!firstUserResponse.IsErrorOccured());

            IList<string> notificationsBefore = member3Notifications.ToList();
            Response<ServicePurchase> secondUserResponse = buyerFacade.PurchaseCartContent(member3Id, paymentDetails);
