...
namespace TestMarketBackend.BusinessLayer.Market.StoreManagment.DiscountTests
{
    internal class BagValueTests
    {
        ...
        [TestCase(150)]
        [TestCase(0)]
        public void testProductAmount(int worth)
        {
            BagValuePredicate pred = new BagValuePredicate(worth);
            Assert.AreEqual(pred.EvaluatePredicate(sbag.Object, store.Object), actualWorth > worth);
        }
    }
}
