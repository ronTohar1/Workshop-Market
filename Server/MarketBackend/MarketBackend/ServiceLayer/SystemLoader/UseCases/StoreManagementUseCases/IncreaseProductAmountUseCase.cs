...
{
    internal class IncreaseProductAmountUseCase : UseCase
    {
        ...
        public IncreaseProductAmountUseCase(string userIdRef, string storeIdRef, string productIdRef, int amount, string ret = "_") : base("IncreaseProductAmount", ret)
        {
            UserIdRef = userIdRef;
        ...
        internal override bool Apply(SystemOperator systemOperator, IDictionary<string, object> varsEnvironment)
        {
            ...
            var res = systemOperator.GetStoreManagementFacade().Value.AddProductToInventory(userId, storeId, productId, Amount);
